package com.example.allinone.jni;
...
public class LibAPI {
    ...
    public native static void GetDeviceList(int DevNumArray[], int CamStatusArray[], int SWiStatusArray[],
            int SWoStatusArray[], int AreaChildArray[], String[] ArrayAreaStr, String[] ArrayGUID,
            String[] ArrayGUName);
